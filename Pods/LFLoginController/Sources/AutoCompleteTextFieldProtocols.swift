...
@objc public protocol AutoCompleteTextFieldDelegate: UITextFieldDelegate {
    ...
    @objc dynamic optional func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool
    
    // became first responder
    @objc dynamic optional func textFieldDidBeginEditing(_ textField: UITextField)
    ...
    @objc dynamic optional func textFieldShouldEndEditing(_ textField: UITextField) -> Bool
    
    // may be called if forced even if shouldEndEditing returns NO (e.g. view removed from window) or endEditing:YES called
    @objc dynamic optional func textFieldDidEndEditing(_ textField: UITextField)
    
    // return NO to not change text. Defaults to YES.
    @objc dynamic optional func textField(_ textField: UITextField, changeCharactersInRange range: NSRange, replacementString string: String) -> Bool
    
    // called when clear button pressed. return NO to ignore (no notifications)
    @objc dynamic optional func textFieldShouldClear(_ textField: UITextField) -> Bool
    
    // called when 'return' key pressed. return NO to ignore.
    @objc dynamic optional func textFieldShouldReturn(_ textField: UITextField) -> Bool
